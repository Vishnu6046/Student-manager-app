...
ALLOWED_HOSTS = [ 'student_manager6046.com', 'student-manager-app-6mc5.onrender.com' ]
...
MIDDLEWARE = [
    ...
    'profile_setup.middleware.RedirectAuthenticatedUserMiddleware',
    'profile_setup.middleware.NoCacheMiddleware',
]
